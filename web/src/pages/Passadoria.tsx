...
const PASSADORIA: QuadroCfg = {
  ...
  nota: "Parte 1 e Parte 2 permanecem separadas na Passadoria — unem-se apenas no Corte.",
  colunas: [
    { cor: "aguardando", titulo: "Aguardando", sub: "Kits", status: "aguardando", tipos: ["pronta-entrega"], acao: "fazer" },
    ...
    { cor: "pronto", titulo: "Finalizados", sub: "Kits", status: "pronto", tipos: ["pronta-entrega"], acao: "enviar" },
