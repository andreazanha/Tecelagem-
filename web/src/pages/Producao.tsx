...
const TECELAGEM: QuadroCfg = {
  ...
  recursoTotal: 8,
  statRecursoLabel: "Máquinas ativas",
  statFila: "Aguardando",
  statFazendo: "Tecendo",
  statPronto: "Tecidos",
  mostrarMaquinas: true,
  nota:
    "Parte 1 (Máq 3) e Parte 2 (Máq 7) seguem separadas até o Corte · Kits separados. Clique no card p/ detalhes.",
  colunas: [
    ...
    { cor: "aguardando", titulo: "Aguardando", sub: "Fila de kits", status: "aguardando", tipos: ["pronta-entrega"], acao: "fazer" },
    ...
    { cor: "pronto", titulo: "Tecidos", sub: "Kits prontos", status: "pronto", tipos: ["pronta-entrega"], acao: "enviar" },
  ],
};
